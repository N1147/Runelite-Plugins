...
@Slf4j
@Singleton
class ARuneDragonsOverlay extends OverlayPanel
{
	private final ARuneDragonsPlugin plugin;
	private final ARuneDragonsConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private ARuneDragonsOverlay(final Client client, final ARuneDragonsPlugin plugin, final ARuneDragonsConfig config)
	{
		super(plugin);
