...
import net.runelite.client.plugins.IronBuilder.IronBuilder;
import net.runelite.client.plugins.IronBuilder.IronBuilderConfig;
...
@Slf4j
@Singleton
class IronBuilderOverlay extends OverlayPanel
{
	private final IronBuilder plugin;
	private final IronBuilderConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private IronBuilderOverlay(final Client client, final IronBuilder plugin, final IronBuilderConfig config)
	{
		super(plugin);
