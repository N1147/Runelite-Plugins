...
@Slf4j
@Singleton
class AZulrahOverlay extends OverlayPanel
{
	private final AZulrahPlugin plugin;
	private final AZulrahConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private AZulrahOverlay(final Client client, final AZulrahPlugin plugin, final AZulrahConfig config)
	{
		super(plugin);
