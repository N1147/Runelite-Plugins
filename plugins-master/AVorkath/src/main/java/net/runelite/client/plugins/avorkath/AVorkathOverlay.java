...
class AVorkathOverlay extends OverlayPanel
{
	...
	@Inject
	private AVorkathOverlay(final Client client, final AVorkathPlugin plugin, final AVorkathConfig config)
	{
		super(plugin);
	...
	{
		if (plugin.botTimer == null || !plugin.startTeaks)
		{
